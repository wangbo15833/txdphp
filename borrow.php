...
<Script language = "JavaScript1.2" src="js/chkborrow.js"></Script>
...
<div class="w992">
<p>注：以下内容应如实填写，以便我们与您联系。同时我们将对您的资料进行严格保密！您的姓名跟电话只有平台能看到，别人看不到！谢谢合作！</p>
	<table width='98%' border=0 align="center" cellpadding=0 cellspacing=1 bgcolor="#EBEBEB">
<form method="post" name="borrow" action="borrow_add_do.php" onSubmit="return borrow_sub();">
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">借款人姓名：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="Name" type="text" class="inp" id="Name" size="20" /><font color="#FF0000">（必填）</font>
                    </td>
                    <td width="60%" align="left"><div id="DispName"></div></td>
        		</tr>
      		</table>
  		</td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">借款数额：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="Amount" type="text" class="inp" id="Amount" size="20" />万元<font color="#FF0000">（必填）</font>
                    </td>
                    <td width="60%" align="left"><div id="DispAmount"></div></td>
        		</tr>
      		</table>
  		</td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">可接受月息：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                        <select name="Interest" class="inp" id="Interest" >
                        	<option value="2">2</option>
                            <option value="5">5</option>
                        </select>%<font color="#FF0000">（必填）</font>
                    </td>
                    <td width="60%" align="left"><div id="DispInterest"></div></td>
        		</tr>
      		</table>
  		</td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">借款期限：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="Deadline" type="text" class="inp" id="Deadline" size="20" />
                    </td>
        		</tr>
      		</table>
  		</td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">借款人省份：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
        <select name="selectp" onChange="selectcityarea('selectp','selectc','borrow');" id="Province">
          <option value="0" selected>不限-- 
        </select><font color="#FF0000">（必填）</font>
                    </td>
                    <td width="60%" align="left"><div id="DispProvince"></div></td>
        		</tr>
      		</table>
  		</td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">借款人城市：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
        <select name="selectc" id="City">
          <option value="0" selected>不限-- 
                    ...
                    <td width="60%" align="left"><div id="DispCity"></div></td>
        		</tr>
      		</table>
  		</td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">抵押物种类：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="Collateral_type" type="text" class="inp" id="Collateral_type" size="20" />
                    </td>
        		</tr>
      		</table>
  		</td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">抵押物位置：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="Collateral_position" type="text" class="inp" id="Collateral_position" size="20" />
                    </td>
        		</tr>
      		</table>
  		</td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">联系电话：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="Tel" type="text" class="inp" id="Tel" size="20" />
                    </td>
        		</tr>
      		</table>
  		</td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">联系QQ：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="QQ" type="text" class="inp" id="QQ" size="20" />
                    </td>
        		</tr>
      		</table>
  		</td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">信息备注：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                        <textarea name="Remark" class="inp" id="Remark" cols="50" rows="10"></textarea>
                    </td>
        		</tr>
      		</table>
  		</td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">验证码：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td align="left">
                    	<input name="Rand" type="text" class="inp" id="Rand" size="10" maxlength="4" style="float:left;" />
                        <div class="dl_rand" style="float:left; margin-left:10px;"><img style="cursor:pointer" title="刷新验证码" id="refresh" border='0' src='lib/code.php' onClick="document.getElementById('refresh').src='lib/code.php?t='+Math.random()"/>
                        </div>
                    </td>
        		</tr>
      		</table>
	...
	<tr bgcolor="#FFFFFF">
		...
		<td height="23">
        	<input name="" type="submit" value="提 交" class="sunmits">
            <input name="" type="reset" class="sunmits" value="重 填" />
        </td>
	</tr>
</form>
</table>
...
<script language="javascript">
first("selectp","selectc","borrow",0,0);
</script>
</body>
</html>