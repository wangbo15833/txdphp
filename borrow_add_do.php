...
$Cotype = trim($_POST['Collateral_type']);
$CoPosition = trim($_POST['Collateral_position']);
$Tel = trim($_POST['Tel']);
$QQ = trim($_POST['QQ']);
...
if ($Rand == $_SESSION['login_check_number']) {
	...
	$sql="insert into borrow (Name,Amount,Interest,Deadline,Province,City,Cotype,CoPosition,Tel,QQ,Remark,IsAudit,Addtime) values('".$Name."','".$Amount."','".$Interest."','".$Deadline."','".$Province."','".$City."','".$Cotype."','".$CoPosition."','".$Tel."','".$QQ."','".$Remark."',0,'".$Addtime."')";
