...
<Script language = "JavaScript1.2" src="js/chklend.js"></Script>
...
<form method="post" name="lend" action="lend_add_do.php" onSubmit="return lend_sub();">
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">放款人姓名：</td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">放款数额：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                    	<input name="Amount" type="text" class="inp" id="Amount" size="20" /><font color="#FF0000">（必填）</font>
                    </td>
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">月息要求：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">放款期限：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">放款人省份：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
                        <select name="selectp" onChange="selectcityarea('selectp','selectc','lend');" id="Province">
	...
	<tr bgcolor="#FFFFFF">
		<td width="15%" height="40" align="right">放款人城市：</td>
    	<td width="85%" height="23" align="center">
    		<table width="98%" border="0" cellspacing="0" cellpadding="0">
      			<tr>
        			<td width="40%" align="left">
...
<script language="javascript">
first("selectp","selectc","lend",0,0);
</script>
</body>
</html>