...
$querySel = "select ID,Name,Amount,Interest,Deadline,Province,City,Tel,QQ,Remark,Addtime,IsAudit from lend";
...
function SureDel(id,page)
{
	if (confirm("您确定要删除该条信息吗？")){
		window.location.href = "lend_del_do.php?id=" + id +"&page=" + page
	}
}
</Script>
</head>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="27%" height="40"><table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="84" height="24" align="center" background="images/tbgg.gif"><a href="lend.php" class="lmenu">放款管理</a></td>
...
<table width='98%' border=0 align="center" cellpadding=0 cellspacing=1 bgcolor="#EEEEEE">
  ...
  <tr>
    <td height="40" bgcolor="#FFFFFF" onMouseOver="this.style.background='#F5F5F5'" onMouseOut="this.style.background='#FFFFFF'"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
        ...
        <?php
			if ($result_show[$i]['IsAudit'] == true) echo "<a href = 'lend_sh.php?id=".$result_show[$i]['ID']."&sh=0' class='lmenu'><font color='#FF0000'>已审核</font></a>";
			if ($result_show[$i]['IsAudit'] == false) echo "<a href = 'lend_sh.php?id=".$result_show[$i]['ID']."&sh=1' class='lmenu'>未审核</a>";
		?>
        </td>
  ...
  ?>
  <tr>
    <td height="40" align="right" bgcolor="#FFFFFF"><div class="pageclass"><?php $subPages=new SubPages($page_size,$nums,$pageCurrent,$sub_pages,"lend.php?page=",2);?></div></td>
  </tr>
</table>
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
