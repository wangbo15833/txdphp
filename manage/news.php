...
$querySel = "select *,(select ClassName from nclass where ID=news.ClassID) as ClassName from news";
$querySel = $querySel . " order by DOrder,Addtime desc"; 
...
function SureDel(id,page)
{
	if (confirm("您确定要删除该条文档吗？")){
		window.location.href = "news_del_do.php?id=" + id +"&page=" + page
	}
}
</Script>
</head>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="40"><table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="84" height="24" align="center" background="images/tbgg.gif"><a href="news.php" class="lmenu">新闻管理</a></td>
        <td width="23"><img src="images/jt.gif" width="23" height="24"></td>
        <td width="10"><a href="admin_add.php" class="lmenu"></a></td>
        <td width="84" align="center" background="images/tbgg.gif"><a href="news_add.php" class="lmenu">添加新闻</a></td>
  ...
  <tr>
    <td width="100%" height="40" bgcolor=#F5F5F5><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="20%" align="center">文档标题</td>
  ...
  <tr>
    <td height="40" bgcolor="#FFFFFF" onMouseOver="this.style.background='#F5F5F5'" onMouseOut="this.style.background='#FFFFFF'"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
        ...
        <td width="20%" align="center"><?php echo $result_show[$i]['Tit'] ?></td>
        ...
        <td width="14%" align="center"><table width="91" border="0" cellspacing="0" cellpadding="0">
          <form action="news_update_order.php?id=<?php echo $result_show[$i]['ID'] ?>" method="post" name="update_order" id="update_order">
            <tr>
...
if ($result_show[$i]['DShow'] == true) echo "<a href = 'news_show.php?id=".$result_show[$i]['ID']."&show=0' class='lmenu'><font color='#FF0000'>显示</font></a>";
if ($result_show[$i]['DShow'] == false) echo "<a href = 'news_show.php?id=".$result_show[$i]['ID']."&show=1' class='lmenu'>不显示</a>";
?></td>
        <td width="4%" align="center"><a href="news_edit.php?id=<?php echo $result_show[$i]['ID'] ?>&page=<?php echo $pageCurrent ?>" class="tmain">编辑</a></td>
  ...
  ?>
  <tr>
    <td height="40" align="right" bgcolor="#FFFFFF"><div class="pageclass"><?php $subPages=new SubPages($page_size,$nums,$pageCurrent,$sub_pages,"news.php?page=",2);?></div></td>
  </tr>
</table>
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
