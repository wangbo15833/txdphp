...
$querySel = "select * from news where ID=".$ID."";
...
<Script language = "JavaScript1.2" src="js/news_check.js"></Script>
</head>
  ...
  <tr>
    <td height="40"><table border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="10">&nbsp;</td>
        <td width="83" align="center" background="images/tbgg.gif"><a href="news_add.php" class="lmenu">添加新闻</a></td>
        <td width="10"><img src="images/jt.gif" width="23" height="24"></td>
        <td width="10"></td>
        <td width="84" align="center" background="images/tbgg.gif"><a href="news_edit.php?id=<?php echo $_GET['id']?>&page=<?php echo $_GET['page']?>" class="lmenu">编辑新闻</a></td>
...
<form method="post" name="news" action="news_edit_do.php" onSubmit="return news_sub();">
  <tr bgcolor="#FFFFFF">
    <td width="15%" height="40" align="right">新闻标题：</td>
    <td width="85%" height="23" align="center"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="16%"><input name="Tit" type="text" class="inp" id="Tit" value="<?php echo $row['Tit']?>" size="70" /></td>
  ...
  <tr bgcolor="#FFFFFF">
    <td width="15%" height="40" align="right">新闻类别：</td>
		  ...
		  while($row_sub=mysql_fetch_array($result_sub)) 
			{
				...
				if ($row['ClassID'] == $result_show[$i]['ID']) $sel_c = "selected";					
  ...
  <tr bgcolor="#FFFFFF">
    <td height="340" align="right">新闻内容：</td>
    <td height="23" align="center"><textarea name="content" style="width:98%;height:300px;visibility:hidden;"><?php echo htmlspecialchars($row['Content']); ?></textarea></td>
  </tr>
  <tr bgcolor="#FFFFFF">
