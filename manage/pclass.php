...
function SureDel(id,page)
{
	if (confirm("您确定要删除该条信息吗？")){
		window.location.href = "pclass_del_do.php?id=" + id +"&page=" + page
	}
}
</Script>
</head>
  ...
  <tr>
    <td height="40"><table border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="84" align="center" background="images/tbgg.gif"><a href="pclass_add.php" class="lmenu">添加分类</a></td>
...
<table width='98%' border=0 align="center" cellpadding=0 cellspacing=1 bgcolor="#EEEEEE">
  ...
  <tr>
    <td height="40" bgcolor="#FFFFFF" onMouseOver="this.style.background='#F5F5F5'" onMouseOut="this.style.background='#FFFFFF'"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
        ...
        <td width="9%" align="center">&nbsp;</td>
        <td width="5%" align="center"><a href="pclass_edit.php?id=<?php echo $result_show[$i]['ID'] ?>&page=<?php echo $pageCurrent ?>" class="tmain">编辑</a></td>
  ...
  ?>
  <tr>
    <td height="40" align="right" bgcolor="#FFFFFF"><div class="pageclass"><?php $subPages=new SubPages($page_size,$nums,$pageCurrent,$sub_pages,"pclass.php?page=",2);?></div></td>
  </tr>
</table>
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
