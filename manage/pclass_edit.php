...
$querySel = "select * from pclass where ID=".$ID."";
...
<Script language = "JavaScript1.2" src="js/pclass_check.js"></Script>
</head>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="40"><table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="84" height="24" align="center" background="images/tbgg.gif"><a href="pclass.php" class="lmenu">展示分类</a></td>
        <td width="23"><img src="images/jt.gif" width="23" height="24"></td>
        <td width="10">&nbsp;</td>
        <td width="83" align="center" background="images/tbgg.gif"><a href="pclass_add.php" class="lmenu">添加分类</a></td>
        <td width="10"><img src="images/jt.gif" width="23" height="24"></td>
        <td width="10"></td>
        <td width="84" align="center" background="images/tbgg.gif"><a href="pclass_edit.php?id=<?php echo $_GET['id']?>&page=<?php echo $_GET['page']?>" class="lmenu">编辑分类</a></td>
...
<form method="post" name="pclass" action="pclass_edit_do.php" onSubmit="return pclass_sub();">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="85%" height="23" align="center"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="16%"><input name="ClassName" type="text" class="inp" id="ClassName" value="<?php echo $row['ClassName']?>" size="30" /></td>
