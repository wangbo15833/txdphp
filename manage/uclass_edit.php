...
$querySel = "select * from uclass where ID=".$ID."";
  ...
  <tr>
    <td height="40"><table border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="10">&nbsp;</td>
        <td width="83" align="center" background="images/tbgg.gif"><a href="uclass_add.php" class="lmenu">添加分类</a></td>
        <td width="10"><img src="images/jt.gif" width="23" height="24"></td>
        <td width="10"></td>
        <td width="84" align="center" background="images/tbgg.gif"><a href="uclass_edit.php?id=<?php echo $_GET['id']?>&page=<?php echo $_GET['page']?>" class="lmenu">编辑分类</a></td>
...
<form method="post" name="uclass" action="uclass_edit_do.php" onSubmit="return uclass_sub();">
  <tr bgcolor="#FFFFFF">
